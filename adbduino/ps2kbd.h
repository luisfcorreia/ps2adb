...
/**
   Input pins for PS/2 Keyboard
*/
#define  kPS2KbdClockPin   2
#define  kPS2KbdDataPin    3

/**
   Input pins for PS/2 Mouse
*/
#define  kPS2MouseClockArduinoPin 6
#define  kPS2MouseDataArduinoPin  7

#define  kPS2KbdModePort   DDRD
#define  kPS2KbdOutPort    PORTD
#define  kPS2KbdInPort     PIND

#define  kPS2MouseClockPin (1<<kPS2MouseClockArduinoPin)
#define  kPS2MouseDataPin  (1<<kPS2MouseDataArduinoPin)
